...
/* synthesis syn_black_box black_box_pad_pin="dclk_in,busy_out,channel_out[4:0],eoc_out,eos_out,vccaux_alarm_out,vccint_alarm_out,user_temp_alarm_out,alarm_out,vp_in,vn_in" */;
  input dclk_in;
  output busy_out;
