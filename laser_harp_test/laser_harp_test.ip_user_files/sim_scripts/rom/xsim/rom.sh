...
#
# Generated by Vivado on Thu Nov 14 22:15:39 -0600 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom xil_defaultlib.rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  rom -key {Behavioral:sim_1:Functional:rom} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_usb.protoinst" -log simulate.log
}
