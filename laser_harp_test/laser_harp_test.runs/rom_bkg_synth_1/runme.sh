...
HD_PWD='C:/Users/estel/laser-harp-fpga/laser_harp_test/laser_harp_test.runs/rom_bkg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_bkg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_bkg.tcl
